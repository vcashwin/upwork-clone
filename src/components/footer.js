...
function Footer() {
  return (
    <div class="font-sans rounded-2xl border bg-[#001E00] flex flex-col text-white text-sm p-6 lg:p-14 justify-between space-y-4">
      {/* Link Container */}
      ...
      <div className="flex flex-col justify-between md:flex-row space-y-4">
        <div className="flex items-center space-x-2">
          <p className="font-bold">Follow Us</p>
          <div className="bg-[#001E00] border-white border p-2 rounded-full hover:bg-[#9AAA97] cursor-pointer">
            <div className="w-[14px] h-[14px] fill-white">
              <FacebookIcon />
            </div>
          </div>
          <div className="bg-[#001E00] border-white border p-2 rounded-full hover:bg-[#9AAA97] cursor-pointer">
